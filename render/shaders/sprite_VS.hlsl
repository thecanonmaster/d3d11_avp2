...
PS_INPUT_SPRITE VSMain(VS_INPUT_SPRITE Input)
{
    PS_INPUT_SPRITE Output;
    
    Output.vPosition = mul(Input.vPosition, g_mSpriteWorldViewProj);
    ...
    if (g_dwMode & MODE_FOG_ENABLED)
    {
        ...
        {
            float4 vPosRelCamera = mul(Input.vPosition, g_mSpriteWorldView);
